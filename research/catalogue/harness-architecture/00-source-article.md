---
title: "Source Article: The Anatomy of an Agent Harness"
date: 2026-04-12
...
## Key Claims to Explore

1. Agent harnesses are the "operating system" around LLMs
2. Beren Millidge (2023): harnesses reinvent the **Von Neumann architecture**
3. LLM = CPU, context = RAM, databases = disk, tools = device drivers, harness = OS
4. Co-evolution principle: models trained with specific harnesses
5. Scaffolding metaphor: harnesses should get THINNER as models improve
6. The 12 components and 7 architectural decisions
7. Anthropic's "dumb loop" philosophy vs LangGraph's explicit state graphs
